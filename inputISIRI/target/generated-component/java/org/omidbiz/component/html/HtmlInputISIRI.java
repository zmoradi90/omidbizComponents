...
import org.omidbiz.component.UIInputISIRI;
...
public HtmlInputISIRI(){
setRendererType("org.omidbiz.InputISIRIRenderer");
}
...
state[4] = _onkeypress;
state[5] = _onkeyup;
state[6] = _onmousedown;
state[7] = _onmousemove;
state[8] = _onmouseout;
state[9] = _onmouseover;
state[10] = _onmouseup;
return state;
}
...
super.restoreState(context, states[0]);
	_onclick = (String)states[1];;
		_ondblclick = (String)states[2];;
		_onkeydown = (String)states[3];;
		_onkeypress = (String)states[4];;
		_onkeyup = (String)states[5];;
		_onmousedown = (String)states[6];;
		_onmousemove = (String)states[7];;
		_onmouseout = (String)states[8];;
		_onmouseover = (String)states[9];;
		_onmouseup = (String)states[10];;
