...
import org.omidbiz.component.html.HtmlLovCloseButton;

public class LovCloseButtonTag extends org.ajax4jsf.webapp.taglib.HtmlComponentTagBase {
...
When the delay time is over, the request will be sent to the server or removed if the newest 'similar' request is in a queue already
    ...
    protected void setProperties(UIComponent component)
    {
		...
		HtmlLovCloseButton comp = (HtmlLovCloseButton) component;
	...
	public String getComponentType() {
		// TODO Auto-generated method stub
		return "org.omidbiz.LovCloseButton";
	}
	...
	public String getRendererType() {
				return "org.omidbiz.LovCloseButtonRenderer";
			}
