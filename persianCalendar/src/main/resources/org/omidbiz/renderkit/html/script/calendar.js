...
Richfaces.Calendar.parseDate = function(dateString, pattern, monthNames, monthNamesShort) {
    ...
    if (match != null) {
        ...
        if (isNaN(yy)) return null; else if (yy < 70) yy += 2000; else if (yy < 100) yy += 1900;
        var mm = parseInt(match[m], 10);
        if (isNaN(mm)) mm = Richfaces.Calendar.getMonthByLabel(match[m], shortLabel ? monthNamesShort : monthNames); else if (--mm < 0 || mm > 11) return null;
...
//    return 32 - new Date(year, month, 32).getDate();
    var solarMonth = gregorianToJalali(year,month, new Date().getDate())[1];
    return getSolarDaysInMonth(year, solarMonth);
}
...
//    return new Date().getMonth();
    var solarMonth = gregorianToJalali(date.getFullYear(),date.getMonth(), date.getDate())[1];
    return getSolarDaysInMonth(date.getFullYear(), solarMonth);
}
function gregorianToJalali(g_y, g_m, g_d) {
    ...
    for (var i = 0; i < gm; ++i)
        g_day_no += getSolarDaysInMonth(g_y, gm);
    ...
    for (var i = 0; i < 11 && j_day_no >= getSolarDaysInMonth(g_y, gm); ++i) {
        j_day_no -= getSolarDaysInMonth(g_y, gm);
    }
    var jm = i + 1;
    var jd = j_day_no + 1;
                        ...
                        [
                            new E('tr', {},
                                    [
                                        ...
                                        new E('td', {'class': 'rich-calendar-tool rich-calendar-tool-close', 'style':function(context) {
            ...
            [
                new E('tbody', {},
                        [
                            new E('tr', {},
                                    [
                                        new E('td', {'class': 'rich-calendar-toolfooter', 'style':function(context) {
                                                    return (this.isEmpty ? 'display:none;' : '');
                                                }},
                                                [
                                                    new ET(function (context) {
                                        ...
                                        new E('td', {'class': 'rich-calendar-toolfooter', 'style':function(context) {
                                                    return (this.isEmpty ? 'display:none;' : '') + (context.calendar.params.disabled || context.calendar.params.readonly || !context.calendar.params.showApplyButton ? 'background-image:none;' : '');
                                                }},
                                                [
                                                    new ET(function (context) {
...
CalendarView.timeEditorLayout = [
    ...
    new E('table', {'id': function(context) {
            ...
            }, 'border': '0', 'cellpadding': '0', 'cellspacing': '0', 'class': 'rich-calendar-time-layout'},
            [
                new E('tbody', {},
                        [
                            new E('tr', {},
                                        ...
                                        new E('td', {'class': 'rich-calendar-time-layout-ok'},
                                                [
                                                    new E('div', {'id': function(context) {
                                                            ...
                                                            }, 'class': 'rich-calendar-time-btn', 'style': 'float:right;', 'onmousedown': "Element.addClassName(this, 'rich-calendar-time-btn-press');", 'onmouseout': "Element.removeClassName(this, 'rich-calendar-time-btn-press');", 'onmouseup': "Element.removeClassName(this, 'rich-calendar-time-btn-press');", 'onclick': function(context) {
                                                                return "$('" + context.calendar.id + "').component.hideTimeEditor(true)";
                                                            }},
                                                            [
                                                                new E('span', {},
                                                                        [
                                        ...
                                        new E('td', {'class': 'rich-calendar-time-layout-cancel'},
                                                [
                                                    new E('div', {'id': function(context) {
                                                            ...
                                                            }, 'class': 'rich-calendar-time-btn', 'style': 'float:left;', 'onmousedown': "Element.addClassName(this, 'rich-calendar-time-btn-press');", 'onmouseout': "Element.removeClassName(this, 'rich-calendar-time-btn-press');", 'onmouseup': "Element.removeClassName(this, 'rich-calendar-time-btn-press');", 'onclick': function(context) {
                                                                return "$('" + context.calendar.id + "').component.hideTimeEditor(false)";
                                                            }},
                                                            [
                                                                new E('span', {},
                                                                        [
...
CalendarView.dayList = [new ET(function (context) {
    return context.day
})];
CalendarView.weekNumber = [new ET(function (context) {
    return context.weekNumber
})];
CalendarView.weekDay = [new ET(function (context) {
