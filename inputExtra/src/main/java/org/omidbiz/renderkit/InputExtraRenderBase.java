...
public class InputExtraRenderBase extends HeaderResourcesRendererBase
{
	...
	public void initializeMask(FacesContext context, UIInputExtra component) throws IOException
	{
		...
		if (parentComponent != null && maskPattern != null)
		{
			...
			sb.append(" jQuery(\"#" + parentComponent.getClientId(context).replace(":", "\\\\:") + "\").mask(\""
					+ maskPattern + "\");");
			sb.append("});");
